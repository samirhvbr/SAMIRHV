...
@section('content')
        ...
        <div class="container" style="position:relative; z-index:1;">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6 s-reveal" data-d="1">
                    ...
                    <p class="s-lead" style="margin-top:1.4rem;">
                    ...
                    <div class="d-flex gap-3 flex-wrap" style="margin-top:2rem;">
                        <a href="{{ route('downloads') }}" class="s-btn s-btn--lg">Ver downloads</a>
                        <a href="https://github.com/samirhvbr" target="_blank" rel="noopener" class="s-btn s-btn--ghost s-btn--lg">
                            <i class="fa-brands fa-github"></i> GitHub
                        </a>
                    </div>
                    <p class="s-hero__trust" style="margin-top:1.6rem;">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="s-lead" style="margin-top:1.2rem;">
                    ...
                    <ul class="s-points" style="margin-top:2rem;">
                        <li>
                    ...
                    <div class="d-flex gap-3 flex-wrap" style="margin-top:2rem;">
                        <a href="https://sshvterm.com" target="_blank" rel="noopener" class="s-btn">Conhecer o SShvTerm <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                    </div>
                </div>

                <div class="col-lg-6">
                    <div class="s-panel s-card--pad" style="padding:clamp(1.4rem,2.4vw,1.9rem);">
                        <div class="d-flex align-items-center gap-2" style="margin-bottom:1.1rem;">
                            <i class="fa-solid fa-sliders" style="color:var(--s-accent-ink-2);"></i>
                            <span class="s-meta" style="color:var(--s-ink-2);">settings.json — política de comandos</span>
                        </div>
                        <div class="s-stack" style="gap:10px; font-family:var(--s-mono); font-size:0.82rem; line-height:1.5;">
                            <div style="display:flex; gap:12px; align-items:baseline;">
                                <span style="color:var(--s-ok); font-weight:600; width:52px; flex-shrink:0;">allow</span>
                                <span style="color:var(--s-ink-2);">ls, cat, git status, systemctl status</span>
                            </div>
                            <div class="s-divider"></div>
                            <div style="display:flex; gap:12px; align-items:baseline;">
                                <span style="color:var(--s-warn); font-weight:600; width:52px; flex-shrink:0;">ask</span>
                                <span style="color:var(--s-ink-2);">sudo *, systemctl restart *, docker *</span>
                            </div>
                            <div class="s-divider"></div>
                            <div style="display:flex; gap:12px; align-items:baseline;">
                                <span style="color:var(--s-danger); font-weight:600; width:52px; flex-shrink:0;">deny</span>
                                <span style="color:var(--s-ink-2);">rm -rf /*, mkfs*, dd of=/dev/*</span>
                            </div>
                        </div>
                        <p class="s-meta" style="margin:1.2rem 0 0; line-height:1.6;">
                            <i class="fa-solid fa-lock" style="color:var(--s-accent-ink-2); margin-right:5px;"></i>
    ...
    {{-- ═══ PROJETOS ═══ --}}
    <section class="s-section" id="projetos">
        <div class="container">

            <div style="max-width:640px; margin-bottom:clamp(2.2rem,4vw,3.2rem);">
                <h2 class="s-h2">Projetos</h2>
                <p class="s-lead s-muted" style="margin-top:0.7rem;">Disponíveis para baixar e usar — sempre na versão mais recente.</p>
            </div>
            ...
            @if($projects->isNotEmpty())
                ...
                @endphp
                <a href="{{ $featured->public_url }}" @if($fLink) target="_blank" rel="noopener" @endif class="s-card s-card--hover s-card--pad s-featured" style="margin-bottom:18px; text-decoration:none;">
                    <span class="s-icon s-icon--lg"><i class="{{ $featured->icon ?: 'fa-solid fa-box-open' }}"></i></span>
                    <div style="min-width:0;">
                        <div class="d-flex align-items-center gap-2 flex-wrap" style="margin-bottom:8px;">
                            <h3 class="s-h3" style="font-size:1.35rem;">{{ $featured->title }}</h3>
                ...
                <div class="s-grid">
                    @foreach($rest as $project)
                        ...
                        <a href="{{ $project->public_url }}" @if($isLink) target="_blank" rel="noopener" @endif class="s-card s-card--hover s-card--pad s-stack" style="text-decoration:none;">
                            ...
                            <h3 class="s-h3" style="font-size:1.1rem; margin-bottom:8px;">{{ $project->title }}</h3>
                            ...
                            <div class="d-flex align-items-center justify-content-between" style="margin-top:16px; padding-top:14px; border-top:1px solid var(--s-line);">
                                ...
                                <span class="s-meta s-accent-ink">abrir <i class="fa-solid fa-arrow-right"></i></span>
                            </div>
                        </a>
                    @endforeach
                </div>
                ...
                <div style="margin-top:clamp(2.2rem,4vw,3rem);">
                    <a href="{{ route('downloads') }}" class="s-btn s-btn--ghost">Ver todos os downloads <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            @else
                <div class="s-card s-card--pad" style="text-align:center; padding:60px 0;">
